    ...
    <div className="flex flex-col items-center animate-in fade-in slide-in-from-bottom-8 duration-700 w-full max-w-4xl px-4">
      <GlassCard className="w-full max-w-2xl text-center flex flex-col items-center gap-10 py-16 px-12 relative overflow-hidden bg-white/80 dark:bg-slate-900/60 border-slate-200 dark:border-white/10 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] dark:shadow-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md">
          <button 
            onClick={onStart}
            className="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-bold py-5 px-8 rounded-2xl flex items-center justify-center gap-3 transition-all duration-300 shadow-[0_20px_40px_-10px_rgba(59,130,246,0.3)] dark:shadow-[0_20px_40px_-10px_rgba(59,130,246,0.5)] group active:scale-[0.98]"
          >
          ...
          <button 
            onClick={onBatch}
            className="flex-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold py-5 px-8 rounded-2xl flex items-center justify-center gap-3 transition-all duration-300 shadow-sm group active:scale-[0.98]"
          >
            <Layers className="w-6 h-6 text-blue-500 dark:text-blue-400" />
            <span className="text-xl">Batch</span>
          </button>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6 w-full pt-8">
          <div className="bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-3xl p-6 flex flex-col items-center gap-3 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors shadow-sm dark:shadow-none">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-base font-bold text-slate-800 dark:text-white tracking-tight">ANN</span>
            </div>
          </div>
          <div className="bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-3xl p-6 flex flex-col items-center gap-3 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors shadow-sm dark:shadow-none">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-base font-bold text-slate-800 dark:text-white tracking-tight">~92%</span>
            </div>
          </div>
          <div className="bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-3xl p-6 flex flex-col items-center gap-3 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors shadow-sm dark:shadow-none">
            <Layers className="w-6 h-6 text-blue-500 dark:text-blue-400" />
            <div className="flex flex-col">
              ...
              <span className="text-base font-bold text-slate-800 dark:text-white tracking-tight">4 Ranges</span>
            </div>
          </div>
        </div>
      </GlassCard>
